...
export class AreaDetailsComponent implements OnInit{
  ...
  private setFormValues(description = '', price = null, duration = null) {
    this.areaForm = this.fb.group({
      areaDescription: new FormControl({value: description, disabled: !this.editionMode}, Validators.required),
      areaPrice: new FormControl({value: price, disabled: !this.editionMode}, Validators.required),
      areaDuration: new FormControl({value: duration, disabled: !this.editionMode}, Validators.required)
    });
  }
